...
class LaporanSawController extends Controller
{
    protected $db;
    ...
    public function index()
    {
        ...
        $stmt->execute();
        $hasilSaw = $stmt->fetchAll(\PDO::FETCH_ASSOC);
        ...
        extract($data);
        require __DIR__ . '/../Views/dashboard/laporan_saw.php';
    }
    ...
    public function downloadPdf()
    {
        ...
        $pdf->Cell(0,10,'Laporan Hasil SAW',0,1,'C');
        $pdf->Ln(5);
