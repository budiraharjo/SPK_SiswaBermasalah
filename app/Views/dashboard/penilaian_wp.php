...
<div class="container-fluid page-body-wrapper">
    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <!-- Form Tambah Data  
            <form action="/dashboard/penilaian-wp/store" method="POST" class="mb-4">
                <div class="row">
                    <div class="col-md-4">
			...
			<!-- Form Import Excel -->
			<form action="/dashboard/penilaian-wp/import" method="POST" enctype="multipart/form-data" class="mb-4">
				<div class="row">
					<div class="col-md-6">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="/dashboard/penilaian-wp/delete" method="POST" style="display:inline;">
                        ...
                        <div class="modal fade" id="modalEdit<?= $n['id_nilai'] ?>" tabindex="-1">
                          <div class="modal-dialog modal-md">
                            <div class="modal-content">
                              <form method="POST" action="/dashboard/penilaian-wp/update/<?= $n['id_nilai'] ?>">
								<input type="hidden" name="id_nilai" value="<?= $n['id_nilai'] ?>">
