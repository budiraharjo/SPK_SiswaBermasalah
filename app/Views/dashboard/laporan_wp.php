...
<div class="container-fluid page-body-wrapper">
    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <h4 class="mb-3">Laporan Hasil WP</h4>
            ...
            <form method="GET" action="">
                <div class="row mb-3">
                    ...
                    <div class="col-md-3 text-end">
                        <a href="/dashboard/laporan-wp/download?periode=<?= urlencode($periode) ?>&search=<?= urlencode($search) ?>" class="btn btn-success" target="_BLANK">Download PDF</a>
                    </div>
                </div>
            </form>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php if (!empty($hasilWp)): ?>
                                    <?php $no = ($page - 1) * $limit + 1; ?>
                                    <?php foreach ($hasilWp as $row): ?>
                                        <tr>
                                            <td><?= $no++ ?></td>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="7" class="text-center">Tidak ada data hasil WP</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    ...
                    <div class="d-flex justify-content-between mt-3">
                        <div>
                            Menampilkan <?= count($hasilWp) ?> data dari total <?= $totalData ?> data hasil WP.
                        </div>
                        <nav>
